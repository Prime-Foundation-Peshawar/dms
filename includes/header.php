...
<head>
  ...
  <?php if (!$is_staging): ?>
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-KLGCNTBPXD"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    gtag('config', 'G-KLGCNTBPXD');
  </script>
  <?php endif; ?>
              ...
              <div class="container">
                <div class="row g-4">
                  ...
                  <div class="col-lg-4">
                    ...
                    <a class="mega-link"
                      href="assets/uploads/admissions/fee-structure/PMC_Fee structure 2026-27.htm"
